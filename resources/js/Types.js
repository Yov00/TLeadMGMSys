...
//  Multisport
export const GET_ALL_MULTISPORT_CARDS = "GET_ALL_MULTISPORT_CARDS";
export const ADD_MULTISPORT_CARD = "ADD_MULTISPORT_CARD";
export const PAY_MULTISPORT_CARD = "PAY_MULTISPORT_CARD";
export const UPDATE_MULTISPORT_CARD = "UPDATE_MULTISPORT_CARD";
export const TOGGLE_MULTISPORTCARD_MODAL = "TOGGLE_MULTISPORTCARD_MODAL";